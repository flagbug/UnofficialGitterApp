...
namespace Gitter.Win8.Views
{
    ...
    /// </summary>
    public sealed partial class RoomsPage : IViewFor<RoomsViewModel>
    {
        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register("ViewModel", typeof(RoomsViewModel), typeof(RoomsPage), new PropertyMetadata(null));
        ...
        public RoomsPage()
        {
            ...
            // Setup the logical page navigation components that allow the page to only show one
            // pane at a time.
            this.navigationHelper.GoBackCommand = new Gitter.Win8.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
            this.itemListView.SelectionChanged += itemListView_SelectionChanged;

            // Start listening for Window size changes to change from showing two panes to showing a
            // single pane
        ...
        private async void itemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            this.ViewModel.SelectedRoom = e.AddedItems.Cast<RoomViewModel>().First();

            await this.ViewModel.SelectedRoom.LoadMessages.ExecuteAsync();
        }
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    // TODO: Invoke Me.itemsViewSource.View.MoveCurrentTo() with the selected item
                    //       as specified by the value of pageState("SelectedItem")
                }
            }
        }
        ...
        // The split page is designed so that when the Window does have enough space to show both
        // the list and the details, only one pane will be shown at at time.
        // 
        ...
        /// </summary>
        /// <returns>
        /// The name of the desired visual state. This is the same as the name of the view state
        /// except when there is a selected item in portrait and snapped views where this additional
        /// logical page is represented by adding a suffix of _Detail.
        /// </returns>
        ...
        /// </summary>
        /// <returns>True if the window should show act as one logical page, false otherwise.</returns>
        ...
        /// . The navigation parameter is available in the LoadState method in addition to page
        /// state preserved during an earlier session.
